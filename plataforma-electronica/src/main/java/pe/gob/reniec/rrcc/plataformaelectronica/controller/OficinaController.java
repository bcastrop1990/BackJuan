...
public class OficinaController {
  ...
  @GetMapping("orec/detalleUbigeo")
  public ResponseEntity<ApiResponse<OficinaBean>> consultarDetalleOrecUbigeo() {
    return ResponseEntity.ok(ApiResponse.<OficinaBean>builder()
            .code(ConstantUtil.OK_CODE)
            .message(ConstantUtil.OK_MESSAGE)
            .data( oficinaService.obtenerOrec() )
            .build());
  }
