...
public class SolicitudRowMapper implements RowMapper<SolicitudBean> {
  ...
  public SolicitudBean mapRow(ResultSet rs, int i) throws SQLException {
    return SolicitudBean.builder()
        ...
        .idArchivoSustento(rs.getLong("ID_ARCHIVO_SUSTENTO"))
        .tipoArchivoSustento(TipoArchivoBean.builder()
            .idTipoArchivo(rs.getString("CO_TIPO_ARCHIVO_SUSTENTO"))
            .nombreArchivo(rs.getString("DE_TIPO_ARCHIVO_SUSTENTO"))
            .build())
        .build();
  }
}
